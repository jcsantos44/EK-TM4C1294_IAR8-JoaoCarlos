...
//Exercicio 1:  Coloque um breakpoint na primeira instrução da
//              função SysTick_Handler (na janela Disassembly)
//               e execute o programa até parar nele:
//              – Qual é o conteúdo do topo da pilha (primeiras 8 double
...
//                0xaf3
//                
//              – Compare esse conteúdo do topo da pilha ao conteúdo dos
//                registradores do núcleo. Quais registradores foram salvos
//                no topo da pilha e em qual ordem?
//                R1, R2, R3

//Exercicio2: – Quais são os valores dos registradores CONTROL e LR?
//            0x0(privileged mode) e 0x0a2b(endereço da main)
//              
